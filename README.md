...
:-------------------------|-------------------------|-------------------------
[Stock App Full Stack](https://stockapp-fullstack-render.onrender.com/) <h3>[Repo](https://github.com/ibrsec/stockapp-fullstack-render)</h3> | React, redux, axios, material, redux-persist, react-router, Express, mongoDB, swagger |![chat](https://github.com/ibrsec/stock-app/raw/master/public/project.gif)
[Stock App fullstack - seperated fe and be](https://stockapp-frontend-selfservice.vercel.app/stock) <h3>[Frontend Repo](https://github.com/ibrsec/stockapp-frontend-selfservice)</h3> <h3>[Backend Repo](https://github.com/ibrsec/backend-stockapi)</h3> | React, redux, axios, material, redux-persist, react-router, Express, mongoDB, swagger |![chat](https://github.com/ibrsec/stock-app/raw/master/public/project.gif)
[Plane Scape Full Stack](https://plane-scape-fs.onrender.com/) <h3>[Repo](https://github.com/ibrsec/plane-scape-fs)</h3> | React, redux, axios, tailwind, redux-persist, react-router, Express, mongoDB, jwt,nodemailer |![chat](https://github.com/ibrsec/plane-scape-fs/raw/main/client/public/project.gif)
...
[Todo Next TS App](https://todonext-mu.vercel.app/) <h3>[Repo](https://github.com/ibrsec/todonext)</h3> | NextJS, Typescript, Tailwind |![iss](https://github.com/ibrsec/todonext/raw/main/public/project.png)
[Rick and Morty Characters](https://rickandmorty-gamma-three.vercel.app/) <h3>[Repo](https://github.com/ibrsec/rickandmorty)</h3> | HTML,CSS, Vanilla JS, Sass |![iss](https://github.com/ibrsec/rickandmorty/raw/main/assets/img/project.gif)
[HugePath App](https://hugepath.vercel.app/) <h3>[Repo](https://github.com/ibrsec/Hugepath)</h3> | HTML, CSS, Javascript |![iss](https://github.com/ibrsec/Hugepath/raw/main/img/p.png)
[Manheim Home Page](https://any-homepage.vercel.app/) <h3>[Repo](https://github.com/ibrsec/any-homepage)</h3> | HTML,CSS, Bootstrap |![iss](https://github.com/ibrsec/any-homepage/raw/main/img/p.gif)
[Photo Gallery](https://photo-gallery-nu.vercel.app/) <h3>[Repo](https://github.com/ibrsec/photo-gallery)</h3> | HTML,CSS, Vanilla JS |![iss](https://github.com/ibrsec/photo-gallery/raw/main/img/p.gif)
